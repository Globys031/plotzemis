          ...
          <div className="card card-container-mobile">
            ...
            >
              ...
              <Form>
                ...
                <FormGroup>
                  <FloatingLabel controlId="floatingPostalCode" label="Type" id="floatingLabel">
                    {/* A placeholder is required on each <Form.Control> */}
                    <Field name="type" type="text" className="form-control form-control-mobile" placeholder="12345" />
                  </FloatingLabel>
                  <ErrorMessage
                    name="type"
                    component="div"
                ...
                <FormGroup>
                  <FloatingLabel controlId="floatingBuildingLength" label="Floor count" id="floatingLabel">
                    {/* A placeholder is required on each <Form.Control> */}
                    <Field name="floorCount" type="number" className="form-control form-control-mobile" placeholder="0" />
                  </FloatingLabel>
                  <ErrorMessage
                    name="floorCount"
                    component="div"
                ...
                <FormGroup>
                  <FloatingLabel controlId="floatingBuildingLength" label="Year" id="floatingLabel">
                    {/* A placeholder is required on each <Form.Control> */}
                    <Field name="year" type="number" className="form-control form-control-mobile" placeholder="0" />
                  </FloatingLabel>
                  <ErrorMessage
                    name="year"
                    component="div"
                ...
                <FormGroup>
                  <FloatingLabel controlId="floatingBuildingLength" label="Price" id="floatingLabel">
                    {/* A placeholder is required on each <Form.Control> */}
                    <Field name="price" type="number" className="form-control form-control-mobile" placeholder="0" />
                  </FloatingLabel>
                  <ErrorMessage
                    name="price"
                    component="div"
